        ...
        for (const user of users) {
            ...
            console.log(user.email);  
                ...
                if (user.friends.length >= maxFriend){
                    maxFriend = user.friends.length
                    arr.push(user.name.first + ' '+user.name.last)
                }

                if(parseInt(user.balance) > max){
                    max = parseInt(user.balance)
                    maxName = user.company;
                }
                else{
                    min = parseInt(user.balance)
                    minName = user.company;
                }
        }
        console.log(arr);
        console.log(max);
